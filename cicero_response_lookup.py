...
def main():
  ...
  # Which we could do (it's just json), but we'd have to do it on our end. Which could perhaps consume a lot of memory, 1000s of strings; but I haven't measured its impact.
