...
#next step is figuring out how to enter admin mode in this code, since those are some of the features we most want to test!
...
print(at.session_state.admin_mode)


assert not at.exception
at.session_state.admin_mode = True
pprint(at.session_state)
