...
def get_all_y(string_to_get_from_streamlit_session_state: str, *args: Any) -> Any | None:
  ...
  You may also use the base case of get_all_y as a simple shorthand for the longer st.session_state.get, which all will agree is much longer to type.
  ...
  get_all_y is a particular type of safe navigation operator, which you can read the wikipedia page about. https://en.wikipedia.org/wiki/Safe_navigation_operator
