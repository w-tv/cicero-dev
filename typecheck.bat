...
uv run python -c "from os import remove; remove('.venv/Lib/site-packages/torch/py.typed') #temporary fix for https://github.com/pytorch/pytorch/issues/124897 . It's quite possible that this code will FileNotFound after the first time it's run. Who cares?"
