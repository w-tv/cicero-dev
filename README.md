...
Addendum on typing: the project has now adopted python-3.12-standard parameter type syntax, but in mypy "PEP 695 generics are not yet supported". So there will be type errors for a while. 😩.
