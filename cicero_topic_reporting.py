...
internal_account_name_to_external_account_name = { #many-to-one relationship #TODO: I'm pretty sure this has all moved to a table we should use instead, by now.
  ...
  'Adam Morgan - Frontline Strategies (TMA)': 'Adam Morgan - TMA',
  ...
  'American Principles Project - Frontline Strategies (TMA)': 'American Principles Project - TMA',
  ...
  'Anna Paulina Luna - Red Wing Strategies (TMA)': 'Anna Paulina Luna - TMA',
  'Anna Paulina Luna for Congress - National Public Affairs (TMA Direct)': 'Anna Paulina Luna - TMA',
  ...
  'Bice': 'Stephanie Bice',
  'Bill Wells - Frontline Strategies (TMA)': 'Bill Wells',
  ...
  'Bob Latta': 'Bob Latta',
  'Border 911 Inc. - Twenty Manor (TMA Direct)': 'Border 911 - TMA',
  'Brent Hatch for Utah': 'Brent Hatch',
  'Brian Jack for Congress - National Public Affairs (TMA Direct)': 'Brian Jack - TMA',
  ...
  'Byron Donalds for Congress - Red Wing Strategies (TMA)': 'Byron Donalds - TMA',
  'CAVPAC': 'CAVPAC',
  ...
  'CSS: Georgia Values Fund': 'Georgia Values Fund',
  ...
  'California Republican Party - Frontline Strategies (TMA)': 'California Republican Party - TMA',
  ...
  'Catherine Templeton for Congress - Flexpoint (TMA)': 'Catherine Templeton',
  ...
  'Club for Growth - IMGE (TMA)': 'Club for Growth - TMA',
  ...
  'Deborah Adeimy for Congress - Frontline Strategies (TMA)': 'Deborah Adeimy - TMA', 
  ...
  'Fired Up PAC - National Public Affairs (TMA Direct)': 'Fired Up PAC - TMA',
  ...
  'Gallagher for Wisconsin - IMGE (TMA)': 'Mike Gallagher - TMA',
  ...
  'Glenn Hegar - FlexPoint Media (TMA)': 'Glenn Hegar - TMA',
  ...
  'Hillsdale College - American Data (TMA)': 'Hillsdale College - TMA',
  ...
  'JR for Ohio - National Public Affairs (TMA Direct)': 'JR Majewski - TMA',
  'Jacobs, Glenn (TN-Knox County)': 'Glenn Jacobs',
  ...
  'Jeff Crank for Congress': 'Jeff Crank',
  ...
  'John Fabbricatore for Colorado (TMA Direct)': 'John Fabbricatore - TMA',
  ...
  'Jon Myers for Congress - Frontline Strategies (TMA)': 'Jon Myers - TMA',
  'Josh Hawley Victory Committee - Onmessageinc (TMA)': 'Josh Hawley - TMA',
  'Judge Joe McGraw - National Public Affairs (TMA Direct)': 'Joe McGraw - TMA',
  'Justin Hicks for Missouri - Politicoin (TMA Direct)': 'Justin Hicks - TMA',
  ...
  'Kenny Xu - Olympic Media (TMA)': 'Kenny Xu - TMA',
  ...
  'LaHood for Congress - IMGE (TMA)': 'Marc LaHood - TMA',
  ...
  'Laurie Buckhout - Flexpoint Media (TMA)': 'Laurie Buckhout - TMA',
  'Leadership for Ohio Fund, LLC': 'Leadership for Ohio Fund',
  'Leslie for Washington - Frontline Strategies (TMA)': 'Leslie Lewallen - TMA',
  'Live Action - American Data (TMA)': 'Live Action - TMA',
  ...
  'McDowell for Congress - Flexpoint Media (TMA)': 'Addison McDowell - TMA',
  'McMorris WFF': 'Cathy McMorris Rodgers',
  'McSwain for Governor': 'Bill McSwain',
  'Meijer, Peter (MI-03)': 'Peter Meijer',
  'Mercuri Victory Committee': 'Rob Mercuri',
  'Mercuri, Rob (PA-17)': 'Rob Mercuri',
  ...
  'Mike Waltz - National Media': 'Michael Waltz',
  'Mission PreBorn - Frontline Strategies (TMA)': 'Mission PreBorn - TMA',
  ...
  'Monique for Congress (TMA Direct)': 'Monique DeSpain - TMA',
  ...
  'My Faith Votes - Frontline Strategies (TMA)': 'My Faith Votes - TMA',
  'NCPD - DonorBureau (TMA)': 'NCPD - TMA',
  'NRCC': 'NRCC',
  'NRSC (TMA)': 'NRSC - TMA',
  'Nancy Dahlstrom - Arena LLC (TMA)': 'Nancy Dahlstrom - TMA',
  ...
  'Ranger PAC - National Public Affairs (TMA Direct)': 'Ranger PAC - TMA',
  ...
  'Rudy Giuliani Freedom Fund - Red Wing Strategies  (TMA)': 'Rudy Giuliani Freedom Fund - TMA',
  ...
  'Stephan Varela for Colorado - On Message Inc (TMA Direct)': 'Stephan Varela - TMA',
  'Steve Garvey for US Senate - Blitz Digital Group LLC (TMA)': 'Steve Garvey - TMA',
  ...
  'Team Elise - Red Wing Strategies (TMA)': 'Elise Stefanik - TMA',
  ...
  'Texas Republican Party - National Public Affairs (TMA Direct)': 'Texas Republican Party - TMA',
  ...
  'Trump National Committee JFC - Launchpad Strategies (TMA Direct)': 'Trump National Committee - TMA',
  ...
  'Wagner': 'Ann Wagner',
  'Walker, Chris (WV-02)': 'Chris Walker',
...
# TODO: refactor from pivoted version to non-pivoted, smaller table: hook_reporting.default.gold_topic_data 
