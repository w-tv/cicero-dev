...
def main() -> None:
  ...
  with col2:
    accounts = st.multiselect("Account", load_account_names(), help="This control allows you to filter on the account name. If nothing in selected in this control all of the accounts will be presented.")
    accounts = external_account_names_to_internal_account_names_list_mapping(load_account_names() if not accounts else accounts)
  with col3:
    project_types = st.multiselect("Project Type", ["Email: Rental Internal", "Text Message: P2P", "Text Message: P2P External", "Email: House", "Text Message: SMS", "Email: Rental External", "Text Message: P2P Internal"], help="This control allows you to filter on the project type. If nothing in selected in this control, no filtering will be done.")
