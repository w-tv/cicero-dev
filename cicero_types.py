...
type Voice_Corporate = Literal["Default", "A16Z", "WCW", "TASC", "1870", "CRES", "Better Solutions", "Highland Fleets", "HAN"]
type Voice_Noncorporate = Literal["Default", "NRCC", "AFPI", "Vivek", "Kiggans", "Arvind", "Joni Journal", "CLF", "RJC", "Crane"]
